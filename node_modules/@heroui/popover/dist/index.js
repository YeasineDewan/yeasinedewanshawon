...
var import_use_aria_overlay = require("@heroui/use-aria-overlay");
function useReactAriaPopover(props, state) {
  ...
  const { overlayProps, underlayProps } = (0, import_use_aria_overlay.useAriaOverlay)(
    {
      isOpen: state.isOpen,
      onClose: state.close,
      shouldCloseOnBlur,
  ...
  return {
    popoverProps: (0, import_shared_utils.mergeProps)(overlayProps, positionProps),
    arrowProps,
    underlayProps,
    placement
  };
...
function usePopover(originalProps) {
  ...
  const getPopoverProps = (props2 = {}) => ({
    ref: domRef,
    ...(0, import_shared_utils2.mergeProps)(popoverProps, otherProps, props2),
    style: (0, import_shared_utils2.mergeProps)(popoverProps.style, otherProps.style, props2.style)
  });
  const getDialogProps = (props2 = {}) => ({
    ...
    "data-arrow": (0, import_shared_utils2.dataAttr)(showArrow),
    ...
    ...(0, import_shared_utils2.mergeProps)(focusProps, dialogPropsProp, props2),
    className: slots.base({ class: (0, import_shared_utils2.clsx)(baseStyles) }),
    style: {
  ...
  const getContentProps = (0, import_react2.useCallback)(
    (props2 = {}) => ({
      ...
      "data-arrow": (0, import_shared_utils2.dataAttr)(showArrow),
      "data-placement": ariaPlacement ? (0, import_aria_utils3.getArrowPlacement)(ariaPlacement, placementProp) : void 0,
      className: slots.content({ class: (0, import_shared_utils2.clsx)(classNames == null ? void 0 : classNames.content, props2.className) })
    }),
  ...
  const getTriggerProps = (0, import_react2.useCallback)(
    (props2 = {}, _ref = null) => {
      ...
      return {
        "data-slot": "trigger",
        ...(0, import_shared_utils2.mergeProps)({ "aria-haspopup": "dialog" }, triggerProps, otherProps2),
        onPress,
        isDisabled,
        className: slots.trigger({
          class: (0, import_shared_utils2.clsx)(classNames == null ? void 0 : classNames.trigger, props2.className),
          // apply isDisabled class names to make the trigger child disabled
          // e.g. for elements like div or HeroUI elements that don't have `isDisabled` prop
          isTriggerDisabled: isDisabled
        }),
        ref: (0, import_shared_utils2.mergeRefs)(_ref, triggerRef)
      };
    },
...
var PopoverTrigger = (props) => {
  ...
  const { onPress, isDisabled, ...restProps } = (0, import_react4.useMemo)(() => {
    return getTriggerProps((0, import_shared_utils3.mergeProps)(otherProps, child.props), childRef);
  ...
  return (0, import_react4.cloneElement)(
    child,
    (0, import_shared_utils3.mergeProps)(restProps, hasHeroUIButton ? { onPress, isDisabled } : buttonProps)
  );
};
  ...
  ({
    ...
    return disableAnimation ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { ...otherProps, ref, children }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_framer_motion3.LazyMotion, { features: domAnimation2, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      import_framer_motion3.m.div,
      {
        ...
        ...(0, import_shared_utils4.mergeProps)(otherProps, motionProps),
        children
      }
    ) });
  }
